...
export default function RequestCard({
  ...
  const handleFlag = (e: any) => {
    // Prevent the card from being pressed
    ...
    Alert.alert(
      "Report Content",
      "Do you want to flag this request for admin review?",
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              await submitReport(user.id, 'request', item.request_id.toString(), "Flagged from Browse Feed");
              Alert.alert("Reported", "Thank you, this post has been flagged for admin review.");
            } catch (err) {
    ...
    >
      <View style={styles.header}>
        ...
        <View style={styles.iconsContainer}>
          ...
          >
            <FontAwesome name="flag-o" size={20} color="#999" />
          </TouchableOpacity>
        </View>
      </View>
